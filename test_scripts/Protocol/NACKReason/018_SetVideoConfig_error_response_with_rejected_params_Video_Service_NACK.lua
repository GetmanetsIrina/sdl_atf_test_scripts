...
--  erroneous result code and rejectedParams to Navi.SetVideoConfig request
--
-- Precondition:
...
-- 2. HMI responds with erroneous result code and rejectedParams to Navigation.SetVideoConfig
-- SDL does:
