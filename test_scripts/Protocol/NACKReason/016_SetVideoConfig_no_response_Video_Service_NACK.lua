...
-- in case NACK received because HMI does not respond to Navi.SetVideoConfig request
--
-- Precondition:
...
-- 2. HMI does not respond to Navigation.SetVideoConfig during default timeout
-- SDL does:
-- - respond with NACK to StartService request because HMI does not respond to Navi.SetVideoConfig request
