...
runner.Step("App1 SetInteriorVehicleData", commonRC.rpcAllowed, { "CLIMATE", 1, "ButtonPress" } )
runner.Step("App2 SetInteriorVehicleData 1st ", common.rpcAllowedWithConsent, { 2, _, "SetInteriorVehicleData", _, 18000  })
