...
common.Step("RPC GetVehicleData, SUCCESS", common.getVehicleData, { handsOffSteeringValue })

common.Title("Test")
common.Step("Policy Table Update with disabling permissions for handsOffSteering",
  common.policyTableUpdate, { ptUpdate })
common.Step("RPC GetVehicleData, DISALLOWED after PTU", common.processRPCUnsuccessRequest,
  { rpc, handsOffSteeringValue, result })
