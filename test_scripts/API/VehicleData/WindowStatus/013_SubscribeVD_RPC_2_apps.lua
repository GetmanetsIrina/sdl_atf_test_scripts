...
common.Step("Register App_2", common.registerApp, { secondAppId })

common.Title("Test")
common.Step("App_1 subscribes to windowStatus data",
  common.subUnScribeVD, { rpcNameSubscribeVD, isExpectedSubscribeVDonHMI, firstAppId })
common.Step("App_2 subscribes to windowStatus data",
  common.subUnScribeVD, { rpcNameSubscribeVD, notExpectedSubscribeVDonHMI, secondAppId })
common.Step("OnVehicleData to App_1 and App_2", common.OnVehicleDataTwoApps)
