...
--  to `gearStatus` vehicle data in case `gearStatus` parameter does not exist in apps assigned policies.
--
-- In case:
-- 1) `gearStatus` parameter does not exist in app's assigned policies.
