...
runner.Step("ButtonPress_CLIMATE", commonRC.rpcDeniedWitCustomParams, {climate_params, 1, "ButtonPress", "INVALID_DATA"})
runner.Step("ButtonPress_RADIO", commonRC.rpcDeniedWitCustomParams, {radio_params, 1, "ButtonPress", "INVALID_DATA"})
