...
runner.Title("Test")
runner.Step("ButtonPress_CLIMATE", commonRC.rpcDeniedWitCustomParams, {paramsStep1, 1, "ButtonPress", "INVALID_DATA"})
runner.Step("ButtonPress_RADIO", commonRC.rpcDeniedWitCustomParams, {paramsStep2, 1, "ButtonPress", "INVALID_DATA"})
